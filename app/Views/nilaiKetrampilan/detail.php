                            ...
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select disabled class="form-control form-control" id="id_kelas">
                                               <?php foreach($kelas as $ke) : ?>
                                                    <?php if($nilaiketrampilan['id_kelas'] == $ke['id_kelas']) : ?>
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select disabled class="form-control form-control" value="<?= $nilaiketrampilan['id_mapel']?>" id="id_mapel" >
                                               <?php foreach($mapel as $ke) : ?>
                                                    <?php if($nilaiketrampilan['id_mapel'] == $ke['id_mapel']) : ?>
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select disabled value="<?php $nilaiketrampilan['id_guru']?>" class="form-control form-control" id="id_guru" >
                                               <?php foreach($guru as $ke) : ?>
                                                    <?php if($nilaiketrampilan['id_guru'] == $ke['id_guru']) : ?>
            ...
            <div class="col-md-12">
                <div class="card">
                                ...
                                <?php foreach($nilai_get as $sis) : ?>
                                    <tr>
                                        <td>
                                            ...
                                            <?php foreach($nilaiketrampilandetail as $nilai_d) : ?>
                    ...
                    <div class="card-footer">
                        <a href="<?=base_url('admin/nilaiKetrampilan')?>" class="btn btn-success">SIMPAN</a>   
                    </div>
                </div>
            </div>
        </div>
