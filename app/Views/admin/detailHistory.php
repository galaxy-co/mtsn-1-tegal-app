...
<div class="content">
        <div class="page-inner">
            <div class="row">
                ...
                <div class="col-md-12">
                <?php foreach($groupedData as $sesesterTahun => $nilai) : list($semster, $tahunAjaran) = explode('-', $sesesterTahun);?>
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-center">
                                <h4 class="card-title">Nilai Harian <?= $type ?> Semester <?php if($semster == 1){echo 'Ganjil';}else{echo 'Genap';}?> Tahun Ajaran  <?=$tahunAjaran?></h4>
